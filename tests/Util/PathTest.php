...
class PathTest extends TestCase
{
    ...
    #[DataProvider('removeBaseProvider')]
    public function testRemoveBase(string $input, string $expected): void
    {
        $path = new Path('/home/roms/rom-testset');
        $this->assertEquals($expected, $path->removeBase($input));
    }
    ...
    public static function removeBaseProvider(): array
    {
        return [
            'simple' => ['/home/roms/rom-testset', ''],
            'simple1' => ['/home/roms/rom-testset/bobby', 'bobby'],
            'simple2' => ['/home/roms/rom-testset/bobby/hill.jpg', 'bobby/hill.jpg'],
        ];
    }
}
