...
class SkyscraperCommandBuilder
{
    ...
    public function build(): array
    {
        ...
        if (isset($this->exts)) {
            $parts['--addext'] = implode(' ', $this->exts);
        }
    ...
    public function addExt(string|array $ext): SkyscraperCommandBuilder
    {
        if (is_string($ext)) {
            $this->exts[] = $ext;
        ...
        $this->exts = array_merge($this->exts ?? [], $ext);
